...
// start-section-6
import { DidKey, getJwkFromKey, KeyDidCreateOptions } from '@credo-ts/core'
...
const resolvedAuthorizationRequest =
  await holder.modules.openId4VcHolderModule.resolveSiopAuthorizationRequest(authorizationRequest)
console.log(
